...
The worst offenders may show just two bars, representing averaged values for two conditions.
This kind of plot adds very little beyond a sentence in the text reporting the two numbers, and is often misleading.
The reason it is misleading is that it *hides variation in the data*. 
(see below for more on the “data plot”)
