...
```{r krushke, fig.margin=TRUE, fig.cap="Clarifying the distinctions between Bayesian and Frequentist paradigms and the ways that they approach inference and estimation. For many settings, we think the estimation mindset is more useful. From Kruschke and Liddell (2018). "}
knitr::include_graphics("images/inference/krushke.png")
```
