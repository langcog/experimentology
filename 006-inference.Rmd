...
Take our tea-tasting example (again). On a frequentist interpretation, the participant has a true accuracy that we can approximate via repeated measurement. 
...
### Bayes Factors and p-values: Practical guidance
...
::: {.exercise}
1. Split up Goodman's (2008) "dirty dozen" in Table \@ref(tab:dirty-dozen) and write a description of why each is a misconception. These can be checked against the original article. 
::: 