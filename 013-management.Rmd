...
```{r management-chain, fig.cap="Illustration of the analytic chain from raw data through to research report.", fig.margin=TRUE}
...
```{r management-git, fig.cap="Visualisation of Git version control showing a series of commits (circles) on three different branches: the main branch (green) and two others (blue and red). Branches can be created and then merged back into the main branch.", fig.margin = TRUE}
...
knitr::kable(names, caption = "Examples of good and bad variable names. Adapted from Broman and Woo (2018).")
```
...
::: {.box data-box="accident_report" data-title="Really anonymous?"}
...
```{r management-sharing-chart, fig.cap="A decision chart for thinking about sharing research products. Adapted from Klein et al. (2018)."}
