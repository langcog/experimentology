...
The meta-science studies reviewed above are remarkably impressive, and provide some clarity on what we should expect from the literature. In particular, the odds of replicability for ageneric social and cognitive psychology finding is likely to be between one third and two thirds. Further, this literature has done a good job of ruling out explanations of replication failure like context sensitivity, expertise, and advice from peer reviewers [@ebersole2020]. 
