...
```{r theory-nomological-net}
#| label: fig-theory-nomological-net
#| fig-cap: "A schematic of what a theory might look like."
...
```{r theory-bronfenbrenner}
#| label: fig-theory-bronfenbrenner
#| fig-cap: "The diagram often used to represent Bronfenbrenner's ecological systems theory. Note that circles no longer denote discrete constructs; arrows can be interpreted as causal relationships, but all constructs are assumed to be fully connected."
#| column: margin
...
```{r theory-roulette}
#| label: fig-theory-roulette
#| fig-cap: "A roulette wheel. Betting on red is not that risky, but betting all your chips on a particular value (*) is much riskier."
#| column: margin
...
::: {.box data-box="depth" data-title="A universal law of generalization?"}
...
```{r theory-shepard, boxfigure=TRUE}
#| label: fig-theory-shepard
#| fig-cap: "The causal theory of similarity and generalization posited by Shepard (1987)."
