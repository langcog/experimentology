...
% custom geometry on part title pages for centering
...
% \iehead{\ifnum\value{chapter}>0 \thechapter\hspace{3pt} \fi} % include chapter number if not 0
% \iohead{\textsc{\leftmark}} % then chapter name
