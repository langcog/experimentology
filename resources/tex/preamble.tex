...
\DeclareCaptionStyle{marginfigure}{labelfont=caps,textfont=caps,labelsep=newline,skip=3pt}
\DeclareCaptionStyle{sidecaption}{labelfont=caps,textfont=caps,labelsep=newline,aboveskip=-1em}
