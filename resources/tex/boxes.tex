...
\usepackage{fontspec}
\newfontfamily{\faS}[Path=./resources/fonts/fontawesome/webfonts/]{fa-solid-900.ttf}
\def\faAppleWhole{{\faS \symbol{"F5D1}}}
\def\faMicroscope{{\faS \symbol{"F610}}}
\def\faLeaf{{\faS \symbol{"F06C}}}
\def\faPersonFallingBurst{{\faS \symbol{"E547}}}
\def\faCode{{\faS \symbol{"F121}}}
\def\faMagnifyingGlassPlus{{\faS \symbol{"F00E}}}
\def\faPenRuler{{\faS \symbol{"F5AE}}}
\def\faComments{{\faS \symbol{"F086}}}
