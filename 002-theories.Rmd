...
Shepard's theory is also both explanatory and predictive. It allows you to give explanations in response to questions like "why is generalization so much lower for shapes that are a bit further apart in psychological space" or broader questions like "why does psychological generalization have an exponential form." And it's predictive in that it suggests how new generalization judgments should change in response to a particular manipulation of psychological distance. Explanation is an important feature of good theories, but it's also easy to trick yourself by using a vague theory to explain a finding **post-hoc** (after the fact). The best test of a theory is typically a new prediction, as we discuss below.
...
Popper's viewpoint is appealing. Many scientists view themselves as trying to make  hypotheses that have increasingly broad scope and then searching for evidence that falsifies them. But scientists also often describe what they do as deriving a prediction from a theory, testing that prediction, and then feeling that the theory has gained credibility from the observations that are consistent with it. That's directly at odds with the falsificationist idea that confirmation is impossible! A falsificationist says that confirmation is an illusion and in fact the theory is simply surviving to be tested another day. The harsh falsificationist perspective seems a bit unpalatable to many scientists. If hundreds of people get happier when they receive money, it seems like this observation confirms the M->H hypothesis! 
...
* Bayesian modeling has been very influential in cognitive science and neuroscience. A good introduction in cognitive science is: Lee, M. D. & Wagenmakers, E. J. (2010). A Course in Bayesian Graphical Modeling for Cognitive Science. 

* A recent introduction with a neuroscience focus is: Ma, W. J., Kording, K. P., & Goldreich, D. (2022). Bayesian models of perception and action: An introduction. 
