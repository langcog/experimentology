...
```{r theory-shepard, fig.cap="Figure 1 from Shepard (1987). Generalization gradients for twelve different kinds of stimuli.", fig.margin=TRUE, boxfigure=TRUE}
...
1. Identify an influential theory in your field or sub-field. Can you draw the "nomological network" for it? What are the key constructs and how are they measured? Are the links between constructs well-specified? Or does our description of a theory in this chapter not fit your example?
