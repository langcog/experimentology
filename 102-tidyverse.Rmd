...
Unlike some of the other tutorials in this book, this one is meant to be worked on interactively. The best way to use it is to download the raw source code from [here](https://raw.githubusercontent.com/langcog/experimentology/main/101-rmarkdown.Rmd) and read through, filling in the exercises as you go. 
...
sgf <- read_csv("data/tidyverse/stiller_scales_data.csv")
```
...
sgf_wide <- read_csv("data/tidyverse/sgf_wide.csv")
```
