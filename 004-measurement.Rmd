...
^[Some authors differentiate between "self-report" and "observational" measures. This distinction seems simple on its face, but actually gets kind of complicated. ]

The second dimension of organization for measures is the difference between implict and explicit behaviors. If we ask our participants to answer a math problem. ^[ 
