...
```
<!-- [MM: I haven't edited notation in any of the plots or other display items.] -->
...
<!-- MM: Changed p to w below to avoid confusion with number of paramters. -->
...
```
<!-- [MM: Should this table just use numerical values? The $y_{i,j}$ notation isn't used later.] -->
