...
3. When experimental items are sampled random from a broader population, always make use of statistical analyses -- such as the ones described below -- that control for this sampling process. 
:::
...
\begin{align}
\label{eq:ols_ttest}
Y_i &= \theta_{\text{milk-first}} + \beta X_i + \epsilon_i \\
\end{align}
...
Y_i &= \theta_{\text{milk-first}} + \beta X_{i1} + \theta_{\text{age}} X_{i2}  + \epsilon_i \\
\end{align}
