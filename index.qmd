...
The centerpiece of the Experimental Methods course is a replication\index{replication} project, reflecting a teaching model first described in [@frank2012]{.content-visible when-format="html"} [Frank and Saxe (\citeproc{ref-frank2012}{2012})]{.content-visible when-format="pdf"} and later expanded on in [@hawkins2018]{.content-visible when-format="html"} [Hawkins et al. (\citeproc{ref-hawkins2018}{2018})]{.content-visible when-format="pdf"}. Each student chooses a published experiment in the literature and collects new data on a preregistered\index{preregistration} version of the same experimental paradigm, comparing their result to the original publication. Over the course of the quarter, we walk through how to set up a replication experiment, how to preregister confirmatory analyses, and how to write a reproducible report on the findings. The project teaches concepts like reliability and validity, which allow students to analyze choices that the original experimenters made---often choices that could have been made differently in hindsight!
...
This book is about psychology experiments. These will typically be short studies conducted online or in a single visit to a lab, often---though certainly not always---with a convenience sample. When we say "experiments" here, we mean **randomized experiments**\index{randomized experiment} where some aspect of the participants' experience is **manipulated**\index{manipulation} by the experimenter and then some outcome variable is **measured**\index{measurement}.^[We use **bold** to indicate the introduction of new technical terms.]
