...
Frank, Michael C., Mika Braginsky, Julie Cachia, Nicholas Coles, Tom E.
Hardwicke, Robert D. Hawkins, Maya B. Mathur, and Rondeline Williams.
2024. _Experimentology: An Open Science Approach to Experimental
Psychology Methods_. MIT Press. <https://doi.org/10.7551/mitpress/14810.001.0001>.
:::
:::
...
The centerpiece of the Experimental Methods course is a replication project, reflecting a teaching model first described in Frank and Saxe (2012)^[Frank, Michael C, and Rebecca Saxe. 2012. “Teaching Replication.” Perspectives on Psychological Science 7: 595–99.] and later expanded on in Hawkins, Smith et al. (2018).^[Hawkins, Robert D, Eric N Smith, Carolyn Au, Juan Miguel Arias, Rhia Catapano, Eric Hermann, Martin Keil, et al. 2018. “Improving the Replicability of Psychological Science Through Pedagogy.” Advances in Methods and Practices in Psychological Science 1 (1): 7–18.] Each student chooses a published experiment in the literature and collects new data on a pre-registered version of the same experimental paradigm, comparing their result to the original publication. Over the course of the quarter, we walk through how to set up a replication experiment, how to pre-register confirmatory analyses, and how to write a reproducible report on the findings. The project teaches concepts like reliability and validity, which allow students to analyze choices that the original experimenters made -- often choices that could have been made differently in hindsight!
...
BibTeX citation:
<pre class="sourceCode code-with-copy quarto-appendix-bibtex"><code class="sourceCode bibtex">@book{experimentology2024,
  author = {Frank, Michael C. and Braginsky, Mika and Cachia, Julie and
    Coles, Nicholas and Hardwicke, Tom E. and Hawkins, Robert D. and
    Mathur, Maya B. and Williams, Rondeline},
  publisher = {MIT Press},
  title = {Experimentology: {An} {Open} {Science} {Approach} to
    {Experimental} {Psychology} {Methods}},
  date = {2024},
  url = {experimentology.io},
  doi = {10.7551/mitpress/14810.001.0001},
  langid = {en}
}</code></pre>

For attribution, please cite this work as:
<div id="ref-frank2024" class="csl-entry quarto-appendix-citeas">
Frank, Michael C., Mika Braginsky, Julie Cachia, Nicholas Coles, Tom E.
Hardwicke, Robert D. Hawkins, Maya B. Mathur, and Rondeline Williams.
2024. <em>Experimentology: An Open Science Approach to Experimental
Psychology Methods</em>. MIT Press. <a href="https://doi.org/10.7551/mitpress/14810.001.0001">https://doi.org/10.7551/mitpress/14810.001.0001</a>.</div>
:::
...
We adopt the Contributor Roles (CRediT) Taxonomy^[Learn more at <https://credit.niso.org/>.] to describe our contributions to this manuscript, and we recommend that you do so in your work as well. 
...
- @sec-theories
  - {{< var roles.w >}}: {{< var authors.mike >}}
  - {{< var roles.e >}}: {{< var authors.nicholas >}}, {{< var authors.tom >}}
- @sec-replication
  - {{< var roles.w >}}: {{< var authors.mike >}}
  - {{< var roles.e >}}: {{< var authors.maya >}}, {{< var authors.tom >}}, {{< var authors.nicholas >}}
- @sec-ethics
  - {{< var roles.w >}}: {{< var authors.rondeline >}}
  - {{< var roles.c >}}: {{< var authors.mike >}}
  - {{< var roles.e >}}: {{< var authors.tom >}}, {{< var authors.julie >}}
- @sec-estimation
  - {{< var roles.c >}}: {{< var authors.maya >}}, {{< var authors.nicholas >}}, {{< var authors.mike >}}
  - {{< var roles.e >}}: {{< var authors.julie >}}, {{< var authors.tom >}}
- @sec-inference
  - {{< var roles.w >}}: {{< var authors.mike >}}
  - {{< var roles.c >}}: {{< var authors.maya >}}
  - {{< var roles.e >}}: {{< var authors.julie >}}, {{< var authors.tom >}}
- @sec-models
  - {{< var roles.c >}}: {{< var authors.maya >}}, {{< var authors.mike >}}
  - {{< var roles.e >}}: {{< var authors.tom >}}, {{< var authors.robert >}}
- @sec-measurement
  - {{< var roles.w >}}: {{< var authors.mike >}}
  - {{< var roles.e >}}: {{< var authors.robert >}}, {{< var authors.tom >}}, {{< var authors.rondeline >}}
- @sec-design
  - {{< var roles.w >}}: {{< var authors.mike >}}
  - {{< var roles.e >}}: {{< var authors.nicholas >}}, {{< var authors.tom >}}
- @sec-sampling
  - {{< var roles.w >}}: {{< var authors.mike >}}
  - {{< var roles.e >}}: {{< var authors.julie >}}, {{< var authors.tom >}}, {{< var authors.maya >}}
- @sec-prereg
  - {{< var roles.w >}}: {{< var authors.tom >}}
  - {{< var roles.e >}}: {{< var authors.mike >}}
- @sec-collection
  - {{< var roles.c >}}: {{< var authors.rondeline >}}, {{< var authors.mike >}}
  - {{< var roles.e >}}: {{< var authors.tom >}}
- @sec-management
  - {{< var roles.w >}}: {{< var authors.mike >}}
  - {{< var roles.e >}}: {{< var authors.tom >}}
- @sec-viz
  ...
  - {{< var roles.e >}}: {{< var authors.mike >}}, {{< var authors.tom >}}, {{< var authors.mika >}}
- @sec-writing
  - {{< var roles.w >}}: {{< var authors.tom >}}
  - {{< var roles.e >}}: {{< var authors.mike >}}
- @sec-meta
  - {{< var roles.c >}}: {{< var authors.nicholas >}}, {{< var authors.maya >}}
  - {{< var roles.e >}}: {{< var authors.mike >}}, {{< var authors.tom >}}
- @sec-conclusion
  - {{< var roles.w >}}: {{< var authors.mike >}}
  - {{< var roles.e >}}: {{< var authors.tom >}}
- @sec-instructors
...
- @sec-tidyverse
  - {{< var roles.w >}}: {{< var authors.mike >}}
  - {{< var roles.e >}}: {{< var authors.julie >}}, {{< var authors.mika >}}
- @sec-ggplot
  - {{< var roles.w >}}: {{< var authors.mike >}}
  - {{< var roles.e >}}: {{< var authors.julie >}}, {{< var authors.mika >}}
- Technical infrastructure
  - {{< var roles.d >}}: {{< var authors.mika >}}, {{< var authors.natalie >}}
