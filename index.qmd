...
* version control using `git` and [GitHub](https://github.com) for allowing collaboration on text documents like code, prose, and data, storing and integrating contributions over time (@sec-git)
...
\url{https://doi.org/10.1177/174569161246}.
