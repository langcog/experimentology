...
Even for students who are working on non-experimental research, we expect that a substantial part of the book content will still be useful, including chapters on replication ([Chapter -@sec-replication]), ethics ([Chapter -@sec-ethics]), statistics ([Chapters -@sec-estimation], [-@sec-inference], [-@sec-models]), sampling ([Chapter -@sec-sampling]), project management ([Chapter -@sec-management]), and reporting ([Chapters -@sec-writing], [-@sec-viz], [-@sec-meta]).
