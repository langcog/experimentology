...
Even for students who are working on non-experimental research, we expect that a substantial part of the book content will still be useful, including chapters on replication (@sec-replication), ethics (@sec-ethics), statistics (chapters [-@sec-estimation], [-@sec-inference], [-@sec-models]), sampling (@sec-sampling), project management (@sec-management), and reporting (chapters [-@sec-writing], [-@sec-viz], [-@sec-meta]).
