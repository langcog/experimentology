...
If experiments are about estimating effects, how do we actually use our experimental data to make these estimates? For our example we'll design a slightly more modern version of Fisher's experiment, shown in @fig-estimation-expt.^[An important piece of context for the work of Ronald Fisher, Karl Pearson, and other early pioneers of statistical inference is that they were all strong proponents of eugenics. Fisher was the founding Chairman of the Cambridge Eugenics Society. Pearson was perhaps even worse, an avowed Social Darwinist who believed fervently in Eugenic legislation. These views are repugnant.] 


```{r estimation-expt, fig.width=5}
#| label: fig-estimation-expt
#| fig-cap: "The structure of our tea tasting experiment."
...
```{r estimation-dag}
#| label: fig-estimation-dag
#| fig-cap: "A directed acyclic graph representing our causal theory of tea quality."
#| column: margin
...
```{r estimation-data, fig.width=3}
#| label: fig-estimation-data
#| fig-cap: "Schematic data from the tea tasting experiment."
#| column: margin
...
```{r estimation-ml, fig.width=5}
#| label: fig-estimation-ml
#| fig-cap: "The best-fitting normal distribution for data from the milk-first condition."
#| column: margin
...
```{r estimation-ml2, fig.width=5}
#| label: fig-estimation-ml2
#| fig-cap: "Comparison of the best-fitting normal distribution and a substantially worse curve."
#| column: margin
...
```{r estimation-bayes}
#| label: fig-estimation-bayes
#| fig-cap: "Bayes rule, annotated."
#| column: margin
...
```{r estimation-bayes-curves}
#| label: fig-estimation-bayes-curves
#| fig-cap: "Bayesian inference about tea ratings with a strong prior on low values."
#| column: margin
...
```{r estimation-bayes-curves-weak}
#| label: fig-estimation-bayes-curves-weak
#| fig-cap: "Bayesian inference about tea ratings with a weak prior on low values."
#| column: margin
...
```{r estimation-bayes-curves-moredata}
#| label: fig-estimation-bayes-curves-moredata
#| fig-cap: "Bayesian inference about tea ratings with a a strong prior on low values and more data."
#| column: margin
...
```{r estimation-data-difference}
#| label: fig-estimation-data-difference
#| fig-cap: "Estimating the average treatment effect from the tea-tasting data."
#| column: margin
...
```{r estimation-es-calc}
#| label: fig-estimation-es-calc
#| fig-cap: "Schematic effect size computation."
