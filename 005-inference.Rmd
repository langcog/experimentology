...
We'll continue using our modern tea-tasting example in this chapter: a between-subjects design in which 48 participants are randomly assigned to drink a milk-first or a tea-first cup, and then rate the tea on a Likert scale from 1 (terrible) to 7 (delicious)
