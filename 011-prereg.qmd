...
![Figure 1 of @berkowitz2015. Estimated years of math achievement gained over the school year across groups.](images/prereg/berkowitz.png){#fig-prereg-berkowitz width="50%"}
...
![By deliberately exploiting analytic flexibility in the processing pipeline of fMRI data, @bennett2009 were able to identify 'brain activity' in a dead Atlantic Salmon.](images/prereg/salmon.png){#fig-salmon .column-margin}
