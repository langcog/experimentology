...
![Registered reports\indexC{registered report} involve an article undergoing peer review both before and after results have been collected (from <https://cos.io/initiatives/registered-reports>, licensed under CC BY 4.0).](images/prereg/registered-reports.png){#fig-reg-reports width="70%" fig-alt="A diagram illustrating stages of a Registered Report: studies undergo peer review before & after results have been collected."}
:::
