...
![Figure 1 of @berkowitz2015. Estimated years of math achievement gained over the school year across groups.](images/prereg/berkowitz-1.png){#fig-prereg-berkowitz}
...
![Estimated years of math achievement gained over the school year across groups in the @berkowitz2016 math app trial. Error bars show 95\\% confidence intervals. Figure reproduced from @frank2016.](images/prereg/ITT.png){#fig-prereg-frank-berkowitz}
...
![Examples of apophenia: Mars Face, Winnie the Pooh Cloud, and Jesus Toast.](images/prereg/apophenia.png){#fig-apophenia}
...
![The Chrysalis Effect, when ugly truth becomes a beautiful fiction.](images/prereg/chrysalis.png){#fig-chrysalis}
...
![Registered Reports (<https://www.cos.io/initiatives/registered-reports>).](images/prereg/registered-reports.png){#fig-reg-reports}
