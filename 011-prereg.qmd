...
```{r prereg-berkowitz, boxfigure=TRUE}
#| label: fig-prereg-berkowitz
#| fig-cap: "Figure 1 of @berkowitz2015. Estimated years of math achievement gained over the school year across groups."
#| column: margin
...
```{r prereg-frank-berkowitz, boxfigure=TRUE}
#| label: fig-prereg-frank-berkowitz
#| fig-cap: "Estimated years of math achievement gained over the school year across groups in the @berkowitz2016 math app trial. Error bars show 95\\% confidence intervals. Figure reproduced from @frank2016."
#| column: margin
...
#| fig-cap: "The garden of forking paths: many justifiable but different analytic choices are possible for an individual dataset."
#| column: margin
...
```{r apophenia, boxfigure=TRUE}
#| label: fig-apophenia
#| fig-cap: "Examples of apophenia: Mars Face, Winnie the Pooh Cloud, and Jesus Toast."
#| column: margin
...
```{r chrysalis, boxfigure=TRUE}
#| label: fig-chrysalis
#| fig-cap: "The Chrysalis Effect, when ugly truth becomes a beautiful fiction."
#| column: margin
...
```{r salmon}
#| label: fig-salmon
#| fig-cap: "By deliberately exploiting analytic flexibility in the processing pipeline of fMRI data, @bennett2009 were able to identify 'brain activity' in a dead Atlantic Salmon."
#| column: margin
...
```{r reg-reports, boxfigure=TRUE}
#| label: fig-reg-reports
#| fig-cap: "Registered Reports (<https://www.cos.io/initiatives/registered-reports>)."
#| column: margin
