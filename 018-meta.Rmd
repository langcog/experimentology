...
Because @paluck2019contact generously shared their data, we can show you what their dataset looks like (Table \@ref(tab:meta-dataset)). We'll use these data as our running example throughout. 
