...
2. The location each document should be within a project folder whose sub-folders serve to identify uniquely the document's function within the project. For example, `/analysis/experiment1/eye_tracking_preprocesssing.Rmd` is clearly the Markdown containing eye-tracking pre-processing for the analysis of data from Experiment 1. 
