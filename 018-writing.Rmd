...
* **Be explicit**. Leaving the meaning of your writing to the reader's imagination is dangerous because different readers may imagine different things! So say what you mean as directly as possible. For example, 

* **Be concrete**. Ideas are often easier to convey when you provide examples. For example... Use figures and diagrams - for example, to describe a series of participant exclusions, use a flow diagram. If the journal limits the number of figures you can use, make use of the supplementary materials.
...
For example, if there is an error in the raw data file, write a script to correct the error rather than changing numbers directly in the data file

1. **Literate programming** (Knuth 1992): Instead of supporting code with documentation (e.g., code), reverse the emphasis by supporting documentation (e.g., your manuscript) with code (e.g., using R Markdown)

2. **Defensive coding**

3. **Testing**

4. **Preserve the computational environment**
