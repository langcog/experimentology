...
A confound (or several confounds) may entirely explain the relationship between two variables (as in DAG #3); but it can also just *partly* explain the relationship. For example, it could be that money does increase happiness, but the causal effect is rather small, and only accounts for a small portion of the observed correlation between them, with the friendship confound (and perhaps other counfounds) accounting for the remainder.
