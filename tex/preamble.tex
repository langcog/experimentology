...
\RedeclareSectionCommand[
  runin=false,
  afterskip=0pt % remove extra space after
]{section}
\RedeclareSectionCommand[
  runin=false,
  afterskip=0pt % remove extra space after
...
\definecolor{captioncolor}{cmyk}{.20,.10,0,.56}
\DeclareCaptionFont{caps}{\small\color{captioncolor}}
\captionsetup{labelfont=caps,textfont=caps}
\DeclareCaptionStyle{sidecaption}{labelfont=caps,textfont=caps}
\DeclareCaptionStyle{marginfigure}{labelfont=caps,textfont=caps}
