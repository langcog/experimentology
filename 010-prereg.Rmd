...
**Motivated reasoning**: Rationalizing prior decisions so they are framed in a favourable light, even if they were irrational [@kunda1990].

```{r apophenia, fig.cap="Examples of apophenia: Mars Face, Winnie the Pooh Cloud, and Jesus Toast.", fig.margin=T}
...
```{r chrysalis, fig.cap="The Chrysalis Effect, when ugly truth becomes a beautiful fiction. Placeholder image - replace with illustration?", fig.margin=T}
