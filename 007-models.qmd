...
![Example stimulus materials analogous to those used in @stiller2015.](images/models/sgf.png){#fig-models-sgf-stim .column-margin}
...
![](007-models_files/figure-html/models-precision-1.png){width=70%}
:::

::: {.content-visible when-format="pdf"}
![](007-models_files/figure-pdf/models-precision-1.png){width=70%}
:::
