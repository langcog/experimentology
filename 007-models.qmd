...
![Decreases in estimation error due to adjusting for covariates, plotted by the N participants in each group and the correlation between the covariate and the outcome.](007-models_files/figure-html/fig-models-precision-1.png){#fig-models-precision}
