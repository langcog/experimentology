...
syllabi |>
  mutate(Chapter = str_replace(Chapter, "Chapter ", ""), 
         Chapter = ifelse(!is.na(Chapter), Chapter, "")) |>
  select(-Difficulty) |>
  knitr::kable(Caption = "A sample 10-week syllabus with only content materials") |> 
  row_spec(color.me, bold = F, color = "black", background = "#ebe8fc")
```
...
syllabi |>
  mutate(Chapter = str_replace(Chapter, "Chapter ", ""), 
         Chapter = ifelse(!is.na(Chapter), Chapter, "")) |>
  select(-Difficulty) |>
  knitr::kable(Caption = "A sample 16-week syllabus with both skills and content materials") |> 
  row_spec(color.me, bold = F, color = "black", background = "#ebe8fc")
```
...
syllabi |>
  mutate(Chapter = str_replace(Chapter, "Chapter ", ""), 
         Chapter = ifelse(!is.na(Chapter), Chapter, "")) |>
  select(-Difficulty) |>
  knitr::kable(Caption = "A sample 16-week syllabus with only content materials") |> 
  row_spec(color.me, bold = F, color = "black", background = "#ebe8fc")
```
