...
![Reliability and validity visualized. The reliability of an instrument is its expected precision. The bias of measurements from an instrument also provide a metaphor for its validity.](images/measurement/reliability-validity.png){#fig-measurement-brandmaier .margin-caption width="50%"}
...
![Computing the coefficient of variation (CV).](images/measurement/cv.png){#fig-measurement-cv .column-margin}
...
![Computing test-retest reliability.](images/measurement/trt.png){#fig-measurement-trt .column-margin}
