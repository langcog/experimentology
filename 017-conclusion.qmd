...
Finally, the last ten years have seen huge progress in the use of statistical models both for understanding data [@mcelreath2018] and for describing specific psychological mechanisms [@ma2023]. In our own work, we have used these models extensively and we believe that they provide an exciting toolkit for building quantitative theories that allow us to explain and to predict the human mind. 
...
\addtocontents{toc}{%
  \protect\setlength{\protect\cftbeforechapskip}{\protect\bigskip}
  \protect\renewcommand{\protect\cftchappresnum}{\protect\appendixname~\space}
  \protect\renewcommand{\protect\cftchapaftersnum}{:}
  \protect\setlength{\protect\cftchapnumwidth}{60pt}
  \protect\setlength{\protect\cftchapindent}{0pt}
}
