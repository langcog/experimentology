...
syllabi |>
  ...
  select(-Difficulty) |>
  kable(caption = "A sample 10-week syllabus with both skills and content materials") |> 
...
syllabi |>
  mutate(Chapter = str_replace(Chapter, "Chapter ", ""), 
         Chapter = ifelse(!is.na(Chapter), Chapter, "")) |>
  select(-Difficulty) |>
  kable(caption = "A sample 10-week syllabus with only content materials") |> 
  row_spec(color.me, bold = F, color = "black", background = "#ebe8fc")
```
...
syllabi |>
  ...
  mutate(Appendix = str_replace(Appendix, "Appendix ", ""), 
         Appendix = ifelse(!is.na(Appendix), Appendix, "")) |>
  select(-Difficulty) |>
  kable(caption = "A sample 16-week syllabus with both skills and content materials") |> 
  row_spec(color.me, bold = F, color = "black", background = "#ebe8fc")
```
...
syllabi |>
  mutate(Chapter = str_replace(Chapter, "Chapter ", ""), 
         Chapter = ifelse(!is.na(Chapter), Chapter, "")) |>
  select(-Difficulty) |>
  kable(caption = "A sample 16-week syllabus with only content materials") |> 
  row_spec(color.me, bold = F, color = "black", background = "#ebe8fc")
```
