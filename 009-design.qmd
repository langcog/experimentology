...
![A between-participants design.](images/design/between2.png){#fig-design-between .column-margin}
...
![A within-participants design, counterbalanced for order.](images/design/within2.png){#fig-design-within .margin-caption}
...
![A between-participants, repeated-measures design.](images/design/rm-between2.png){#fig-design-rm-between .margin-caption}
...
![A between-participants, pre-post design.](images/design/pre-post2.png){#fig-design-pre-post .margin-caption}
...
![Three schematic designs. (left) Control and treatment are two levels of a nominal variable. (middle) Control is compared to ordered levels of a treatment. (right) Treatment level is an interval or ratio variable such that points can be connected and a parametric curve can be extrapolated.](images/design/dose-response2.png){#fig-design-dose-schema .margin-caption}
