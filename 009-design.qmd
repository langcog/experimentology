...
![A within-participants design,\index{experimental design!within-participants} counterbalanced for order (discussion of counterbalancing below).](images/design/within.png){#fig-design-within .margin-caption width=70% fig-alt="A diagram starting with the structure of 9.5, then participants swap treatment/control assignments, flow to measure."}
...
![A between-participants,\index{experimental design!between-participants} repeated-measures design.](images/design/rm-between.png){#fig-design-rm-between .margin-caption width=70% fig-alt="A diagram starting with the structure of 9.5, then participants each flow to measure two more times."}
...
![A between-participants,\index{experimental design!between-participants} pre-post design.](images/design/pre-post.png){#fig-design-pre-post .margin-caption width=55% fig-alt="A diagram where 2 participants flow to measure to control to measure, 2 participants flow to measure to treatment to measure."}
