...
![Moral permissability as a function of belief and outcome. Results from @young2007, annotated with the estimated effects. Simple effects measure differences between the individual conditions and the neutral belief, neutral outcome condition. The interaction measures the difference between the predicted sum of the two simple effects and the actual observed data for the negative belief, negative outcome condition.](images/design/young2007-data.png){#fig-design-young-data .margin-caption width=70%}
...
![A within-participants design, counterbalanced for order (discussion of counterbalancing below).](images/design/within.png){#fig-design-within .margin-caption width=70%}
...
![Pros and cons of between- vs. within-participant designs. We recommend within-participant designs when possible.](images/design/between-within.png){#fig-design-between-within .margin-caption width=50%}
...
![A between-participants, repeated-measures design.](images/design/rm-between.png){#fig-design-rm-between .margin-caption width=70%}
...
![A between-participants, pre-post design.](images/design/pre-post.png){#fig-design-pre-post .margin-caption width=55%}
...
![Three schematic designs. (left) Control and treatment are two levels of a nominal variable. (middle) Control is compared to ordered levels of a treatment. (right) Treatment level is an interval or ratio variable such that points can be connected and a parametric curve can be extrapolated.](images/design/dose-response.png){#fig-design-dose-schema .margin-caption width=80%}
...
![Magnitudes of expectancy effects. From @rosenthal1994.](images/design/rosenthal2004.png){#fig-design-rosenthal .margin-caption width=70%}
