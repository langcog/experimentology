...
![Original data from @kovacs2010. Error bars show 95\\% confidence intervals.](images/design/kovacs-original.png){#fig-design-kovacs-original}
...
![The primary outcome graph for @jaeggi2008.](images/design/jaeggi.png){#fig-design-jaeggi}
...
![The four sub-experiments of @jaeggi2008, now disaggregated. Panels show 8- (A), 12- (B), 17- (C), and 19-session (D) studies. Note the different scales and measures. RAPM = Raven's Advanced Progressive Matrices; BOMAT = Bochumer Matrizentest. From @redick2013.](images/design/jaeggi-disaggregated.png){#fig-design-jaeggi-disagg}
