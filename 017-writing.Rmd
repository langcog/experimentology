...
2. **Describe the error** - the reader needs to know the exact nature of the problem.
3. Describe the implications of the error - the reader needs to know how the error should affect their interpretation of the results.
4. Describe what you have done to address the error - the reader needs to know if the error has been 
5. Describe how the error occurred. 
6. Describe any changes you have introduced to your workflow to reduce the likelihood of a similar error occurring again.
7. Acknowledge who identified the error (if they wish to be identified).
