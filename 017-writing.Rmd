...
* **Be explicit**. Leaving the meaning of your writing to the reader's imagination is dangerous because different readers may imagine different things! So say what you mean as directly and precisely as possible.

* **Be concrete**. Ideas are often easier to convey when you provide examples. For example... Use figures and diagrams - for example, to describe a series of participant exclusions, use a flow diagram. If the journal limits the number of figures you can use, make use of the supplementary materials. Use videos to convey methods or interactions with participants.
...
Its not your responsibility to design perfect studies or never make a mistake. But it *is* your responsibility to handle limitations and errors in a transparent and professional manner ^[As jazz musician Miles Davis once said, “If you hit a wrong note, it’s the next note that you play that determines if it’s good or bad.”]. It also your responsibility to communicate all relevant information about your study to enable other scientists to make an informed assessment. This includes methodological information, but also additional contextual information, like potential conflicts of interest or deviations from a preregistration. Finally, you will need to meet some scholarly obligations with regards to authorship and citations.



### Responsible disclosure and interpretation

**Don't overclaim**. Calibrate your conclusions to the evidence. Title - don't overclaim. Title should describe the research aim and method, rather than the result.
...
### Responsible handling of errors and critiques
...
### Responsbile authorship and citation
