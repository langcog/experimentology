...
We notice that many participants (`r round(mean(ms$reject == 0),2)*100`%) never reject in the entire experiment.
...
::: {.box .code}
This last histogram is very similar to the ones above; this time we `count` twice, plotting the count of trial counts!
