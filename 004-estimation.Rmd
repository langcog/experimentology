...
Our task in this chapter will be to estimate the quality of the tea when it is milk-first and when it is tea-first. More formally, we want to use our **sample** of 50 tea judgments to estimate a **population parameter** that we can't directly observe, namely the true perceived quality of all possible milk-first cups and of all possible tea-first cups. 
