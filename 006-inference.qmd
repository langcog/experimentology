...
Instead of dichotomous frequentist or Bayesian hypothesis testing, we follow our thematic emphasis on [measurement precision]{.smallcaps}\index{measurement precision} and advocate for a *measurement* strategy, which is more suited toward questions (3) and (4) [@cumming2014;@kruschke2018]. The goal of these strategies is to yield an accurate and precise estimate of the relationships underlying observed variation in the data. 
...
### Nonparametric resampling under the null {-}\index{resampling}
