...
![Sampling distribution of samples from a biased coin (N=2 flips per sample). Bar height is the proportion of flips resulting in a particular mean.](images/inference/cl-2.png){#fig-inference-coin-2 .column-margin width=80%}
