...
#| tbl-cap: "@jeffreys1998 interpretation guidelines for Bayes Factors."
#| column: margin

tribble(~`BF range`, ~`Interpretation`,
...
expand_grid(N = c(12,24,48,96), 
  ...
  summarise(`p value` = papaja::printp(t.test(x = rating[condition == "milk first"],
...
![A small tea-tasting experiment with a skewed distribution of ratings.](images/inference/skewed.png){#fig-inference-permutation}
