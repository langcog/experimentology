...
![](001-experiments_files/figure-html/experiments-randomization-1.png){width=70%}
:::

::: {.content-visible when-format="pdf"}
![](001-experiments_files/figure-pdf/experiments-randomization-1.png){width=70%}
:::
