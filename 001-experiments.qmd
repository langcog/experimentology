...
::: {title="learning goals" .callout-note collapse=false}
...
```{r experiments-randomization, fig.width=5.5, fig.height=4.5, boxfigure=TRUE}
#| label: fig-experiments-randomization
