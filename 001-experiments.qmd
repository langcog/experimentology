...
![In principle, experiments allow us to "snip away" the friend confound by holding it constant (though in practice, it can be tough to figure out how to hold something constant when you are talking about people as your unit of study).](images/experiments/money3-drawing.png){#fig-experiments-money3 .column-margin}
...
![](001-experiments_files/figure-html/experiments-randomization-1.png){width=60%}
:::
...
![The anatomy of a randomized experiment.](images/experiments/anatomy.png){#fig-experiments-anatomy .margin-caption width=70%}
