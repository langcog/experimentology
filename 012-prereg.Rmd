...
```
Because the authors made their data openly available, it was possible for us to do a simple first analysis to examine the causal effect of interest [Figure \@ref(fig:prereg-frank-berkowitz); @frank2016]. Since this analysis was not favorable to the primary intervention -- and because it was not reported in the paper -- we worried that the authors had analyzed the data several ways and chosen to present an analysis that was more favorable to their hypotheses of interest. The original authors responded that their analyses were based on prior research and argued that the disagreement about how the data should be analyzed was philosophical [@berkowitz2016]. 
Disagreements about data analysis are an important feature of the scientific discourse. The broader point, though, is that we can't know whether the original analysis was influenced by looking at the data. As we'll see below, this kind of data-dependent analysis can lead to substantial bias in reported effects.
