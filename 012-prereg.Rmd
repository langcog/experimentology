...
Although this finding appeared striking, the figure didn't show an estimate of the primary causal effect of interest, namely the effect of study condition on math scores. Instead the data were presented as estimated effects for specific points -- a "matched" subgroup in panel A and the entire group in panel B -- both broken down by app usage. 
...
```
Because the authors made their data openly available, it was possible for us to do a simple first analysis to examine the causal effect of interest, which appeared to be very weak [Figure \@ref(fig:prereg-frank-berkowitz); @frank2016]. Since this analysis was not favorable to the primary intervention -- and because it was not reported in the paper -- we worried that the authors had chosen an analysis that "looked better" with respect to their hypotheses of interest. The original authors responded that their analyses were based on prior research and argued that the disagreement about how the data should be analyzed was philosophical [@berkowitz2016]. 


Disagreements about data analysis are an important feature of the scientific discourse. The broader point, though, is that we can't know whether the original analysis was *post hoc* because it was influenced by looking at the data. As we'll see below, data-dependent analysis can lead to substantial bias in reported effects.
If the analysis plan had been preregistered, this simple step would have reduced the risk of bias and hence increased the value of this otherwise high-quality study.
