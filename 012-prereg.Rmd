...
::: {.case-study}
🔬 Case study: Undisclosed analytic flexibility?
...
::: {.interactive}
🪜Example box. Only human: Cognitive biases and skewed incentives
...
Deliberately taking advantage of evidentiary degrees of freedom and selectively reporting research outcomes is known by various names, like p-hacking, cherry picking, data dredging, and it is unethical because it involves hiding highly relevant information. But you should also be aware that outcome-dependent analysis incurs a risk of bias even if a researcher has good intentions, doesn't explicitly try multiple pathways, and honestly reports everything they did. 
...
::: {.interactive}
🪜Example box. Preregistration and friends: A toolbox to address researcher degrees of freedom
