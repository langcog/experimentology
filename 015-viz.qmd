...
![A dataset constructed by @yanai2020 which revealed a picture of a gorilla when the raw data were plotted.](015-viz_files/figure-html/fig-viz-gorilla-1.png){#fig-viz-gorilla width=50%}
...
![A suspiciously uniform distribution abruptly cutting off at 50k miles. Ring the alarm!](015-viz_files/figure-html/fig-viz-uniform-1.png){#fig-viz-uniform width="70%"}
