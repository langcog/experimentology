...
As a result, it became more common to show the 95\% confidence interval\indexC{confidence interval (CI)} instead: [-1.96 $\times$ SEM, 1.96 $\times$ SEM].
