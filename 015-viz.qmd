...
An obstetrician and anesthesiologist named John Snow\index{Snow, John} proposed an alternative theory: rather than spreading through foul air, he thought that cholera\index{cholera} was spreading through a polluted water supply [@snow1855mode].\index{Snow, John}
...
\footnotesize
```{r tbl-datasaurus}
#| tbl-cap: Summary statistics (means, standard deviations, and correlations) for each dataset in the Datasaurus Dozen\index{Datasaurus} (Matejka 2017).
