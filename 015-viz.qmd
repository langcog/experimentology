...
![Mapping out a cholera epidemic [@snow1854report]. Dotted line shows region for which Broad Street pump is nearest.](images/viz/snow_cholera_voronoi.png){#fig-viz-cholera width="45%"}
...
![Map showing the counts of COVID hospitalizations by state since August 2020 as of January 2024 (from the CDC COVID Data Tracker, <https://covid.cdc.gov/covid-data-tracker>). _Usage does not constitute endorsement or recommendation by the U.S. Government, Department of Health and Human Services, or Centers for Disease Control and Prevention._](images/viz/cdc-covid-map.png){#fig-viz-covid width="55%"}
...
Curves like the following, showing the weekly counts of new cases, allow us to see other patterns, like the *rate of change*.
...
![Rates of COVID cases by vaccination status (from the CDC COVID Data Tracker, <https://covid.cdc.gov/covid-data-tracker>). _Usage does not constitute endorsement or recommendation by the U.S. Government, Department of Health and Human Services, or Centers for Disease Control and Prevention._](images/viz/vaccination.png){#fig-viz-cases2 width="55%"}
...
![Principles of visual perception can help guide visualization choices. Based on @mackinlay1986 [see also @cleveland1984].](images/viz/viz_hierarchy.png){#fig-viz-hierarchy .column-margin}
...
![Heatmap showing a specific range of continuous parameters where an effect emerged. @barnett2022, Figure 3 (licensed under CC BY 4.0).](images/viz/viz_heatmap_example.png){#fig-viz-heatmap width="35%"}
:::
