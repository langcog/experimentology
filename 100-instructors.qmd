...
syllabi <- read_csv("data/instructor_guide/Content_Skills_10wk.csv") 
color.me <- which(syllabi$Difficulty == "adv")

syllabi |>
  mutate(Chapter = str_replace(Chapter, "Chapter ", ""), 
         Chapter = ifelse(!is.na(Chapter), Chapter, "")) |>
  mutate(Appendix = str_replace(Appendix, "Appendix ", ""), 
...
syllabi <- read_csv("data/instructor_guide/Content_10wk.csv") 
color.me <- which(syllabi$Difficulty == "adv")
...
syllabi <- read_csv("data/instructor_guide/Content_Skills_16wk.csv") 
color.me <- which(syllabi$Difficulty == "adv")
...
syllabi <- read_csv("data/instructor_guide/Content_16wk.csv") 
color.me <- which(syllabi$Difficulty == "adv")
