...
```{r git-meme}
knitr::include_graphics("images/git/cher_meme.jpg")
```
...
Have you ever sent a collaborator what you *think* is a final copy of a manuscript, perhaps titled "Manuscript final" only to get back an updated version from them called "Manuscript final - JC"? So you make the requested changes and send it back to them as "Manuscript FINAL FOR REAL THIS TIME", just as you receive an email from another collaborator with more edits in a file called "Manuscript final - MF"? If hearing this is bringing back stressful memories, then please read on - we are here to help!
