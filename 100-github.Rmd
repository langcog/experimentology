...
If prompted, enter your GitHub username and newly generated PAT in the place of your password^[If you would like a credential helper to help you store the PAT, follow instructions [here](https://docs.github.com/en/get-started/getting-started-with-git/caching-your-github-credentials-in-git) based on your operation system]. 
Now you should have a cloned copy of the empty repo on your Desktop. 
...
Open the README file in a text editor^[There will be lots of files that are simple text files, with **.md**, **.rmd** etc. as filetypes.  You can open all these with a text editor. Although your computer comes with a default one (e.g. Notepad, TextEdit), we would recommend downloading [Sublime Text](https://www.sublimetext.com/3), which is free and has a lot of powerful tools that will be helpful in the future.] and write a sentence or two describing your repo, and save your changes. (Read the [basics of markdown](https://guides.github.com/features/mastering-markdown/) and use it appropriately in formatting your README.)
...
<span style="color: red;">**IMPORTANT WARNING**</span>: After you’ve finished inspecting a checkout, make sure you get back to where you started [the latest commit on the main branch] by typing:
