...
```
Three-way interactions are hard to think about! The affect X belief X outcome interaction tells you about the difference in permissability that's due to all three factors being present as opposed to what you'd predict on the basis of your estimates of the two-way interactions. 

generalized M-factor designs. M factors with N levels gives you $M^N$ conditions. 

In practice, such designs are difficult
...
```{r, fig.cap="A between-participants, repeated-measures design."}
g <- DiagrammeR::grViz("digraph {
  graph [layout = dot, rankdir = LR]
