...
How could we make a validity argument for the Dylan intervention? We could draw on different senses of validity. Listening to Dylan in the lab seems face valid, since it's related to the construct we care about, music listening while working at the computer at home. It's also ecologically valid since listening and writing in the lab is not that  different than the home equivalent. But it's hard for us to go further in this particular case because the manipulation is so close to the construct we're trying to measure. In other cases, the validity of a manipulation is less clear. 

::: {.accident-report}
⚠️ Accident report: Priming 
