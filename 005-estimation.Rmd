...
```{r estimation-bayes-curves, fig.cap="Bayesian inference about tea ratings with a low prior."}
...
```{r estimation-bayes-curves-weak, fig.cap="Bayesian inference about tea ratings with more data."}
...
```{r estimation-bayes-curves-moredata, fig.cap="Bayesian inference about tea ratings with more data."}
