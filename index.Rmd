...
We introduce and advocate for an approach to reproducible study planning, analysis, and writing. This approach depends on an ecosystem of open-source software tools, which we introduce in the book's appendices. Note that these appendices are available online at <http://experimentology.io> but not in the print version of the book, since their content is best viewed in the web format.
