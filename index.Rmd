...
* Version control using `git` and [GitHub](http://github.com), allowing collaboration on text documents like code, prose, and data, storing and integrating contributions over time (Appendix \@ref(github)),
...
* The `ggplot2` plotting package, which makes it easy to create flexible data visualizations for both confirmatory and exploratory data analyses  (Appendix \@ref(github)).
