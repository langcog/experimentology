...
A Quarto file contains several parts. Most essential are the header, the body text, and code chunks. When you render the resulting document, you will get the output---text combined with the results of running the code---in one of a number of output formats.
